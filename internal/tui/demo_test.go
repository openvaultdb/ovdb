...
func TestTryADemoInstallsAndOpensTheApp(t *testing.T) {
	...
	for _, want := range []string{"The TODO demo is ready", "Two lists, To buy and To watch, are stored as files in", "Your apps and AI agents can use them through the OVDB server.",
		"What next? • Open TODO app ovdb demo open • Install TODO AI skill (ask the person first) ovdb skills install todo-demo • Explore data ovdb explore --db todo", "o open the TODO app · s install TODO AI skill · e explore data · Enter done"} {
