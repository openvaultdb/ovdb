...
var Rows = []Row{
	...
	{ID: "15", Capability: "Browse data (read-only)", CLI: []string{"ovdb list", "ovdb get"}, TUI: "browse", Web: "/browse", Implemented: true},
	// A working directory is a shell concept; the TUI and web console show a
	// browsable tree instead (E4).
	{ID: "16", Capability: "Navigate paths", CLI: []string{"ovdb cd", "ovdb pwd"}, Exceptions: []string{"E4"}, Implemented: true},
	// Editing records is for the CLI, agents and apps (E5).
	{ID: "17", Capability: "Write records", CLI: []string{"ovdb set", "ovdb add", "ovdb delete"}, Exceptions: []string{"E5"}, Implemented: true},
